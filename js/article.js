...
//                     console.log(data);
//                     // ici on peut exploiter nos donnée
//                     let articleDisplayArea = document.querySelector("section.articlesection");
...
//                     <article>
//                     <div>
//                         <h1 class="articleTitle">${data["articles"][id]["title"]}</h1>
//                         <p class="authorName">${data["articles"][id]["author"]}</p>
//                         </div>
//                     <section>
//                         <img class="articleImage" src="${data["articles"][id]["img"]}" alt="">
//                         <p class="articleText">${data["articles"][id]["content"]}
//                         </p>
//                         <p>Article ID: ${data["articles"][id]["id"]}</p>

//                     </section>
//                 </article>`

//                     articleDisplayArea.innerHTML = str;
//                 }
